...
async function fetchPhishNet(
  ...
  logger.logApiResponse("phish.net (shows)", showsData);
  ...
  logger.logApiResponse("phish.net (setlist)", setlistData);
...
async function fetchKGLW(
  ...
  logger.logApiResponse("kglw.net", data);
...
async function fetchSetlistFm(
  ...
  logger.logApiResponse("setlist.fm", data);
